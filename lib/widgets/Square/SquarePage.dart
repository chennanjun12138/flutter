import 'dart:async';
import 'dart:convert';
import 'package:flutter_application_1/widgets/Square/ThemePage.dart';
import 'package:flutter_application_1/widgets/Square/recommend_booklist/RecommendBookListDetail.dart';
import 'package:flutter_application_1/widgets/Square/recommend_booklist/RecommendMovieListDetail.dart';
import 'package:flutter_application_1/rpx.dart';
import 'package:flutter/material.dart';
import 'package:flutter_application_1/widgets/Square/recommend/RecommendPage.dart';
import 'package:flutter_application_1/widgets/Square/book_review/BookReview.dart';
import 'package:flutter_application_1/widgets/Square/movie_review/MovieReview.dart';
import 'package:flutter_application_1/widgets/Square/recommend_booklist/RecommendBookListPage.dart';
import 'package:flutter_application_1/widgets/Square/ranking_list/RankingList.dart';
import 'package:http/http.dart' as http;
import 'package:flutter_application_1/widgets/Square/recommend_booklist/RecommendMovieListPage.dart';
...
class SquarePage extends StatefulWidget {
  ...
  _HomeItemDemoPageState createState() => _HomeItemDemoPageState(
      session_id: session_id, email: email, user_name: user_name);
}

class _HomeItemDemoPageState extends State<SquarePage> {
  _HomeItemDemoPageState({Key key, this.session_id, this.email, this.user_name})
      : super();
  ...
  Future<void> getmovieremark_remark(int j, String dest_id) async {
    final response2 = await http.get(Uri.parse(
        'http://638ca501.r2.cpolar.cn/comment_query?type=8&dest_id=$dest_id'));
  ...
  Future<void> getmovieremark(int j, String dest_id) async {
    final response2 = await http.get(Uri.parse(
        'http://638ca501.r2.cpolar.cn/comment_query?type=5&dest_id=$dest_id'));
    if (response2.statusCode == 200) {
      var utf8ResponseBody = utf8.decode(response2.bodyBytes);
      Map<String, dynamic> responseBody = json.decode(utf8ResponseBody);
      if (responseBody.containsKey("size")) {
  ...
  Future<void> getmovielike(int j, String dest_id) async {
    final response2 = await http.get(Uri.parse(
        'http://638ca501.r2.cpolar.cn/likes_query?type=5&dest_id=$dest_id'));
    if (response2.statusCode == 200) {
      var utf8ResponseBody = utf8.decode(response2.bodyBytes);
      Map<String, dynamic> responseBody = json.decode(utf8ResponseBody);
      if (responseBody.containsKey("size")) {
  ...
  //TODO 添加“点赞”（POST）
  Future<void> postmovielike(
      String session_id, String type, String dest_id) async {
    print(dest_id);
    var headers = {
  ...
  void getNetMovieReviewData() {
    Future.wait([
      ...
      for (int i = 0; i < moviereviews.length; i++) {
        Future(() => getmovielike(
            moviereviews[i]["movie_reaction_id"], moviereviews[i]["movie_id"]));
      }
      for (int i = 0; i < moviereviews.length; i++) {
  ...
  Future<void> getremark(int j, String dest_id) async {
    final response2 = await http.get(Uri.parse(
        'http://638ca501.r2.cpolar.cn/comment_query?type=6&dest_id=$dest_id'));
    if (response2.statusCode == 200) {
      var utf8ResponseBody = utf8.decode(response2.bodyBytes);
      Map<String, dynamic> responseBody = json.decode(utf8ResponseBody);
      if (responseBody.containsKey("size")) {
  ...
  Future<void> getlike(int j, String dest_id) async {
    final response2 = await http.get(Uri.parse(
        'http://638ca501.r2.cpolar.cn/likes_query?type=6&dest_id=$dest_id'));
    if (response2.statusCode == 200) {
      var utf8ResponseBody = utf8.decode(response2.bodyBytes);
      Map<String, dynamic> responseBody = json.decode(utf8ResponseBody);
      if (responseBody.containsKey("size")) {
  ...
  void getNetBookReviewData() {
    Future.wait([
      ...
      for (int i = 0; i < bookreviews.length; i++) {
        Future(() => getlike(
            bookreviews[i]["book_reaction_id"], bookreviews[i]["book_id"]));
      }
      for (int i = 0; i < bookreviews.length; i++) {
        Future(() => getremark(
            bookreviews[i]["book_reaction_id"], bookreviews[i]["book_id"]));
  ...
  Future<void> getbooklist() async {
    ...
    var request = http.Request(
        'GET', Uri.parse('http://638ca501.r2.cpolar.cn/booklist_query'));
    request.headers.addAll(headers);
    http.StreamedResponse response = await request.send();
    if (response.statusCode == 200) {
  ...
  Future<void> getmovielist() async {
    var headers = {'User-Agent': 'Apifox/1.0.0 (https://www.apifox.cn)'};
    var request = http.Request(
        'GET', Uri.parse('http://638ca501.r2.cpolar.cn/movielist_query'));
    request.headers.addAll(headers);
    http.StreamedResponse response = await request.send();
    if (response.statusCode == 200) {
      String responseContent =
  ...
  Future<void> getbook(String flag, String book_id) async {
    ...
    var request = http.Request('GET',
        Uri.parse('http://638ca501.r2.cpolar.cn/book_query?book_id=$book_id'));
    request.headers.addAll(headers);
    http.StreamedResponse response = await request.send();
    if (response.statusCode == 200) {
      String responseContent =
  ...
  Future<void> getmovie(String flag, String movie_id) async {
    ...
    var request = http.Request(
        'GET',
        Uri.parse(
            'http://638ca501.r2.cpolar.cn/movie_query?movie_id=$movie_id'));
    request.headers.addAll(headers);
    http.StreamedResponse response = await request.send();
    if (response.statusCode == 200) {
      String responseContent =
  ...
  Future<void> getbookreviewsList() async {
    final response2 = await http
        .get(Uri.parse('http://638ca501.r2.cpolar.cn/book_reaction_query'));
    if (response2.statusCode == 200) {
      var utf8ResponseBody = utf8.decode(response2.bodyBytes);
      Map<String, dynamic> responseBody = json.decode(utf8ResponseBody);
      setState(() {
  ...
  Future<void> getmoviereviewsList() async {
    final response2 = await http
        .get(Uri.parse('http://638ca501.r2.cpolar.cn/movie_reaction_query'));
    if (response2.statusCode == 200) {
      var utf8ResponseBody = utf8.decode(response2.bodyBytes);
      Map<String, dynamic> responseBody = json.decode(utf8ResponseBody);
      setState(() {
  ...
  void getrecommendRList() async {
    final response2 = await http
        .get(Uri.parse('http://638ca501.r2.cpolar.cn/recommend_query'));
    if (response2.statusCode == 200) {
      var utf8ResponseBody = utf8.decode(response2.bodyBytes);
      Map<String, dynamic> responseBody = json.decode(utf8ResponseBody);
    ...
    return Scaffold(
      ...
      children: <Widget>[
        Column(children: <Widget>[
          ...
          Padding(
            padding:
                EdgeInsets.only(left: rpx(20), right: rpx(20), top: rpx(5.0)),
                      ...
                      IconButton(
                        onPressed: () {
                          Navigator.push<int>(context, MaterialPageRoute(
                            ...
                            return RecommendPage(recommends, list, books,
                                movies, movie_id, book_id);
                          }));
                        },
                        icon: Image.asset("assets/images/command.jpg"),
                        iconSize: rpx(48.0),
                      ),
                  ...
                  Column(
                    children: [
                      IconButton(
                        ...
                        icon: Image.asset("assets/images/books.jpg"),
                        iconSize: rpx(48.0),
                      ),
                        ...
                        onPressed: () {
                          Navigator.push<int>(context, MaterialPageRoute(
                            ...
                            return MovieReview(
                                ...
                                mapthumbmovie,
                                mapremarkmovie,
                                mapremarkcontentmovie,
                                mapremark_remarkmovie);
                          }));
                        },
                        icon: Image.asset("assets/images/films.jpg"),
                        iconSize: rpx(48.0),
                      ),
                  ...
                  Column(
                    children: [
                      IconButton(
                        ...
                        icon: Image.asset("assets/images/rangelist.jpg"),
                        iconSize: rpx(48.0),
                      ),
                ...
                Row(
                  ...
                  children: [
                    ...
                    TextButton(
                        onPressed: () {
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (_) => RecommendBookListPage(booklist)));
                        },
                        child: Text(
                          "更多 >",
                          style: TextStyle(
                              fontSize: rpx(20.0), color: Colors.black38),
                        ))
                  ],
                ),
              ],
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: DecorationImage(image: AssetImage(
                                    // "assets/images/${booklist[0]["booklist_picture"]}"
                                    "assets/images/beijin.jpg"), fit: BoxFit.fill),
                              ),
                              alignment: Alignment.center,
                            ),
                          ),
                          Text(booklist[0]["booklist_name"].toString()),
                        ],
                      ),
                    ),
                    //第二个书单
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: Colors.white,
                                image: DecorationImage(image: AssetImage(
                                    //  "assets/images/${booklist[1]["booklist_picture"]}"
                                    "assets/images/books.jpg"), fit: BoxFit.fill),
                              ),
                              alignment: Alignment.center,
                            ),
                          ),
                          Text("booklist[1][booklist_name]"
                              // "booklist[1]["booklist_name"]"
                              ),
                        ],
                      ),
                    ),
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: Colors.white,
                                image: DecorationImage(image: AssetImage(
                                    //  "assets/images/${booklist[2]["booklist_picture"]}"
                                    "assets/images/books.jpg"), fit: BoxFit.fill),
                              ),
                              alignment: Alignment.center,
                            ),
                  ...
                  children: [
                    ...
                    TextButton(
                        onPressed: () {
                          Navigator.of(context).push(MaterialPageRoute(
                              builder: (_) =>
                                  RecommendMovieListPage(movielist)));
                        },
                        child: Text(
                          "更多 >",
                          style: TextStyle(
                        ...
                        children: <Widget>[
                          GestureDetector(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (_) =>
                                      RecommendMovieListDetail(movie)));
                            },
                            child: Container(
                              width: rpx(120),
                              height: rpx(160),
                              decoration: BoxDecoration(
                                color: Colors.white,
                                image: DecorationImage(image: AssetImage(
                                    // "assets/images/${movielist[0]["movielist_picture"]}"
                                    "assets/images/books.jpg"), fit: BoxFit.fill),
                              ),
                              alignment: Alignment.center,
                            ),
                        ...
                        children: <Widget>[
                          GestureDetector(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (_) =>
                                      RecommendMovieListDetail(movie2)));
                            },
                            child: Container(
                              width: rpx(120),
                              height: rpx(160),
                              decoration: BoxDecoration(
                                color: Colors.white,
                                image: DecorationImage(image: AssetImage(
                                    //"assets/images/${movielist[1]["movielist_picture"]}"
                                    "assets/images/books.jpg"), fit: BoxFit.fill),
                              ),
                              alignment: Alignment.center,
                            ),
                        ...
                        children: <Widget>[
                          GestureDetector(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (_) =>
                                      RecommendMovieListDetail(movie3)));
                            },
                            child: Container(
                              width: rpx(120),
                              height: rpx(160),
                              decoration: BoxDecoration(
                                color: Colors.white,
                                image: DecorationImage(image: AssetImage(
                                    //"assets/images/${movielist[2]["movielist_picture"]}"
                                    "assets/images/books.jpg"), fit: BoxFit.fill),
                              ),
                              alignment: Alignment.center,
                            ),
