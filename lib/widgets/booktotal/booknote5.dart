...
import 'package:flutter_application_1/model/shupinglist.dart';
...
import 'package:flutter_application_1/widgets/booktotal/bookpingjia.dart';
import 'package:flutter_application_1/widgets/booktotal/includebooklist.dart';
...
class booknote5 extends StatelessWidget {
  ...
  Widget getContentImage() {
    return Image(
      image: AssetImage('assets/images/${b1.book_picture}'),
      height: 180,
    );
  }
...
Widget getContentImage2() {
  return Image(
    image: AssetImage('assets/images/haibao.webp'),
    height: 75,
    width: 120,
  );
}
