...
import 'package:flutter_application_1/widgets/message/messageImage.dart';
...
class yingdanview extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return ScrollHomePageState(
        b1, movies, yikanmovies, planmovies, yingdans, watchs);
  }
}
...
class ScrollHomePageState extends State {
  ...
  Widget buildListViewItemWidget(int index) {
    ...
    return new Container(
      ...
      child: messageImage(
          movies[k], movies, yikanmovies, planmovies, yingdans, watchs),
    );
  }
}
