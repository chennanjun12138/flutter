...
class dianying extends StatefulWidget {
  ...
  List<String> res;
  String session_id;
  dianying({Key key, this.select, this.bangdan1, this.res, this.session_id})
      : super(key: key);

  @override
  dianyingState createState() =>
      dianyingState(select, bangdan1, res, session_id);
}
...
class dianyingState extends State<dianying> {
  ...
  List<String> res;
  String session_id;
  dianyingState(this.select, this.bangdan1, this.res, this.session_id);
  @override
  ...
  Widget buildListViewItemWidget(int index) {
    String url = "assets/images/${movies[index].movie_picture}";
