...
import 'package:flutter_application_1/widgets/message/addbangdan.dart';
import 'package:flutter_application_1/widgets/message/edityingdan.dart';
import 'package:flutter_application_1/widgets/message/yingdanmovie.dart';
...
class yingdanxiangqing extends StatelessWidget {
  ...
  List<movie> movies;
  String session_id;
  yingdanxiangqing({Key key, this.bangdan1, this.movies, this.session_id})
      : super(key: key);
  @override
        ...
        child: Padding(
          ...
          child: Column(
            children: <Widget>[
              ...
              yingdanview(
                  bangdan1, movies, yikanmovies, planmovies, yingdans, watchs),
            ],
          ),
        ),
      ),
