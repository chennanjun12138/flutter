...
import 'package:flutter_application_1/widgets/message/yingdanxiangqing.dart';

class yingdan extends StatelessWidget {
  moviedan m1;
  List<movie> movies;
  String session_id;
  yingdan({Key key, this.m1, this.movies, this.session_id}) : super(key: key);
  @override
  ...
  Widget getimage() {
    ...
    String url = "assets/images/${movies[k1].movie_picture}";
    String url2 = "assets/images/saohei.webp";
    String url3 = "assets/images/${movies[k2].movie_picture}";
    String url4 = "assets/images/saohei.webp";
    return Row(
      children: [
        ClipRRect(
