...
import 'package:flutter_application_1/model/dianzanlist.dart';
...
import 'package:flutter_application_1/model/yingpinglist.dart';
import 'package:flutter_application_1/model/yingpingmodel.dart';
import 'package:flutter_application_1/widgets/message/includemoviedan.dart';
import 'package:flutter_application_1/widgets/message/messagenote2.dart';
import 'package:flutter_application_1/widgets/message/messageping.dart';
...
class messagenote extends StatelessWidget {
  ...
  List<movie> movies = [];
  String session_id;
  messagenote({Key key, this.m1, this.yingdans, this.movies, this.session_id})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    String url2 = "assets/images/1668557646608.webp";
    return Scaffold(
        appBar: AppBar(),
            ...
            children: <Widget>[
              Row(
                ...
                children: <Widget>[
                  Container(
                    child: Image(
                      image: AssetImage(url == "assets/images/" ? url2 : url),
                      height: 160,
                    ),
                  ),
                  Expanded(
