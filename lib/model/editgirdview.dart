...
import 'package:flutter_application_1/widgets/booktotal/addbooksearch.dart';
import 'package:flutter_application_1/widgets/booktotal/addbookshoudong.dart';
import 'package:flutter_application_1/widgets/message/dianying.dart';
...
class girdview extends StatelessWidget {
  ...
  Widget danimage(int index) {
    ...
    String url = "assets/images/${books[id].book_picture}";
