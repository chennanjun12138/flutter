...
import 'package:flutter_application_1/model/bookdanlist.dart';
import 'package:flutter_application_1/model/booklist.dart';
import 'package:flutter_application_1/model/jingli.dart';
import 'package:flutter_application_1/model/jinglilist.dart';
import 'package:flutter_application_1/model/yuduzhuangtailist.dart';
import 'package:flutter_application_1/model/yueduzhuangtai.dart';
import 'package:flutter_application_1/widgets/booktotal/addbook.dart';
import 'package:flutter_application_1/widgets/booktotal/mybooklist.dart';
import 'package:flutter_application_1/widgets/booktotal/shudanlistItem.dart';
import 'package:flutter_application_1/widgets/booktotal/zaidu.dart';
import 'dart:convert';
...
import 'widgets/booktotal/shujia.dart';
import 'package:image_picker/image_picker.dart';
import 'widgets/booktotal/addshudan.dart';
...
class firstState extends State<first> {
  ...
  Widget build(BuildContext context) {
    ...
    print(
        "P:${session_id} ${books.length} ${reads.length} ${readsums.length} ${bookdans.length} ${mybookdans.length} ${jinglis.length}");
