...
import 'package:flutter_application_1/model/moviedanlist.dart';
import 'package:flutter_application_1/model/movielist.dart';
import 'package:flutter_application_1/model/watch.dart';
import 'package:flutter_application_1/model/watchlist.dart';
import 'package:flutter_application_1/widgets/message/xiangkan.dart';
import 'package:flutter_application_1/widgets/message/yikan.dart';
...
import 'package:flutter_application_1/widgets/message/jijiangshangying.dart';
...
void getbangdan() async {
  final dio = Dio();
  try {
    Response response = await dio.get(url + "/movielist_query?user_id=test");
    Map<String, dynamic> data = response.data;
...
class Message extends StatefulWidget {
  String session_id;
  Message({Key key, this.session_id}) : super(key: key);

  @override
  MessageState createState() => MessageState(session_id);
}

class MessageState extends State<Message> {
  String session_id;
  MessageState(this.session_id);
  ...
  Widget jijiangshangyin() {
    return Column(
      ...
      children: <Widget>[
        ...
        SizedBox(height: 10),
        Center(
          child: Image.asset("assets/images/haibao.webp"),
        ),
